...
1. **RAM modul hiba**: egy konkrét stick hibás
2. **Slot / kontakt / mechanikai hiba**: egy adott foglalat instabil
3. **BIOS / beállítás instabilitás**: XMP / órajel / feszültség / tréning
4. Ritkább: platform-specifikus memóriavezérlő érzékenység
...
Ha szeretnéd, ugyanehhez írok egy **rövid `SANITIZE.md`-t** is (a “nem publikálok logot” policy-t 10 sorban), hogy a repo még kerekebb legyen.
